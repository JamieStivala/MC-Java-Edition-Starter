module.exports =
{
  'pc': {
    ...
    '1.14': {
      'biomes': require('./minecraft-data/data/pc/1.14/biomes'),
      'items': require('./minecraft-data/data/pc/1.14/items'),
      'recipes': require('./minecraft-data/data/pc/1.14/recipes'),
      'entities': require('./minecraft-data/data/pc/1.14/entities'),
      'language': require('./minecraft-data/data/pc/1.14/language'),
      'protocol': require('./minecraft-data/data/pc/1.14/protocol'),
      'version': require('./minecraft-data/data/pc/1.14/version')
    },
    '1.14.1': {
      'biomes': require('./minecraft-data/data/pc/1.14/biomes'),
      'items': require('./minecraft-data/data/pc/1.14/items'),
      ...
      'entities': require('./minecraft-data/data/pc/1.14/entities'),
      'language': require('./minecraft-data/data/pc/1.14/language'),
      'protocol': require('./minecraft-data/data/pc/1.14.1/protocol'),
      'version': require('./minecraft-data/data/pc/1.14.1/version')
    }
  },
  'pe': {
    '0.14': {
